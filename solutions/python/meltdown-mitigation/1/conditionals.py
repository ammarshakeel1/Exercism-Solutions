...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    upper_normal_threshold = threshold + (threshold * 0.1)
    lower_normal_threshold = threshold - (threshold * 0.1)


    if production < low_threshold:
        return 'LOW'
    elif lower_normal_threshold < production < upper_normal_threshold:
        return 'NORMAL'
    else:
        return 'DANGER'

print(fail_safe(temperature=1000, neutrons_produced_per_second=30, threshold=30000))
